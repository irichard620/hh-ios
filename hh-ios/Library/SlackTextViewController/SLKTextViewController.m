...
- (void)textDidUpdate:(BOOL)animated
{
    ...
    if ([self canPressRightButton]) {
        _textInputbar.rightButton.enabled = YES;
        [_textInputbar.rightButton setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    } else {
        _textInputbar.rightButton.enabled = NO;
        [_textInputbar.rightButton setTitleColor:[UIColor colorWithRed:0.82 green:0.85 blue:0.86 alpha:1.0] forState:UIControlStateNormal];
    }
...
- (void)slk_setupViewConstraints
{
    ...
    self.scrollViewProxy.translatesAutoresizingMaskIntoConstraints = false;
    self.autoCompletionView.translatesAutoresizingMaskIntoConstraints = false;
    self.typingIndicatorProxyView.translatesAutoresizingMaskIntoConstraints = false;
